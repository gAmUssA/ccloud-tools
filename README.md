...
That provides you the flexibility to run these tools anywhere -- whether if it is on-premise or in any given Cloud provider. Though is not necessarily too complex to set these up by yourself -- some developers would like to set down this Ops burden and have everything up-and-running in the Cloud, using a horizontally scalable, fault-tolerant topology. And of course: with everything hooked up automatically with Confluent Cloud.
