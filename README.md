...
That provides you the flexibility to run these tools anywhere -- whether if it is On-Premise or in any given Cloud provider. Though is not necessarily that complex to set up these tools by yourself -- some developers would like to set down this Ops burden and have everything up-and-running in their chosen Cloud provider. Course... automatically hooked up with Confluent Cloud.
